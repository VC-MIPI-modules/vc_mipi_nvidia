...
#downloads
DEV_URL=https://developer.nvidia.com/downloads/embedded/l4t/r36_release_v5.0
...
case $VC_MIPI_SOM in
        AGXXavier|XavierNX|XavierNXSD|AGXOrin|OrinNX8GB|OrinNX16GB|OrinNano4GB_SD|OrinNano8GB_SD|OrinNano4GB_NVME|OrinNano8GB_NVME|OrinAGX32GB|OrinAGX64GB)
                BSP_FILE=Jetson_Linux_r36.5.0_aarch64.tbz2
                ;;
esac

RFS_FILE=Tegra_Linux_Sample-Root-Filesystem_r36.5.0_aarch64.tbz2
SRC_FILE=public_sources.tbz2

CHECK4MD5=0

BSP_FILE_CHECKSUM="6f0625f1b764b516a7cae96250df2aa6"
RFS_FILE_CHECKSUM="c2c42138a3b47dcbd004685a4024091f"
SRC_FILE_CHECKSUM="fbd728297d3d8b38ed66fba2aecdc97b"

. $BIN_DIR/config/L4T/urls_35.1.0+.sh

#configure
PATCHES=('kernel_Xavier_36.5.0')
