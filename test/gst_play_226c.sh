...
echo -----------------------------------------------------------------
echo "   Play VC MIPI sensor IMX226C stream on Jetson by GStreamer"
echo "Usage:"
echo "   $0 [sensor_id]"
echo "where:"
...
nvvidconv flip-method=0 ! 'video/x-raw,width=680, height=506' ! nvvidconv ! nvegltransform ! nveglglessink -e
