...
## Version 0.8.0 ([History](VERSION.md))
...
2. Copy the camera device tree to the folder listed in the following table
   ...
   | ------------------------ | ------------- | ---------------------------------- |
   | NVIDIA Jetson Nano       | NVIDIA DevKit | NV_DevKit_Nano_B01/tegra210-camera-vc-mipi-cam.dtsi <br> => /hardware/nvidia/platform/t210/porg/kernel-dts/porg-platforms |
