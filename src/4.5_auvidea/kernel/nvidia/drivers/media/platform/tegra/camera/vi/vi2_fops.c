...
#define TRACE_TEGRA_CHANNEL_EC_INIT     0      /* DDD - tegra_channel_ec_init - trace */
#define TEGRA_CHANNEL_EC_INIT_TIMEOUT   0x7fffffff // 10000 // 200    /* CCC - tegra_channel_ec_init - timeout in ms, def=200 */
...
#if TRACE_TEGRA_CHANNEL_EC_INIT
    pr_err("%s: timeout=%d ms\n", __func__, TEGRA_CHANNEL_EC_INIT_TIMEOUT);
#endif

//    chan->timeout = msecs_to_jiffies(200);  // original
    chan->timeout = msecs_to_jiffies(TEGRA_CHANNEL_EC_INIT_TIMEOUT);
