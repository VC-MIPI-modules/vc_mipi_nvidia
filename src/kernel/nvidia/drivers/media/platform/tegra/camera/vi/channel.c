...
#define TRACE_TEGRA_CHANNEL_UPDATE_FORMAT   0   /* DDD - tegra_channel_update_format - trace */
...
#if TRACE_TEGRA_CHANNEL_UPDATE_FORMAT
...
#define TRACE_TEGRA_CHANNEL_QUEUE_SETUP     0   /* DDD - tegra_channel_queue_setup - trace */
...
#if TRACE_TEGRA_CHANNEL_QUEUE_SETUP
    dev_err(chan->vi->dev, "channel.c: %s(): nbuffers=%d\n", __func__, *nbuffers);
#endif
...
#define TRACE_TEGRA_CHANNEL_ALLOC_BUFFER_QUEUE  0   /* DDD - tegra_channel_alloc_buffer_queue - trace */

#if TRACE_TEGRA_CHANNEL_ALLOC_BUFFER_QUEUE
    dev_err(chan->vi->dev, "%s(): num_buffers=%d\n", __func__, num_buffers);
#endif
