...
static const imx183_reg imx183_mode_5440X3694[] = {
...
static const imx183_reg *imx183_mode_table[] = {
    [IMX183_MODE_5440X3694]    = imx183_mode_5440X3694,
...
//    if(s_data->fmt_width >= 1920 && s_data->fmt_height >= 1080)
    {
      priv->cam_mode = IMX183_MODE_5440X3694;
    }
//    else
//    {
...
//    if(priv->cam_mode != IMX183_MODE_5440X3694)
    {
