...
//      {
//
////Exposure time  [s] = (1 H period) * (Number of lines per frame - SHS) + 13.73 (TBD) [µs]
//// Exposure time [s] = (XTRIG low level pulse width [µs]) + 13.73 (TBD)[µs]
...
//    priv->sen_clk = 13000000;       // clock-frequency: imx273=74Mhz
